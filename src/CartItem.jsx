...
dispatch(removeItem(item)); // Dispatch action to update Redux store
// Re-fetch cart data to trigger re-render
const updatedCart = useSelector((state) => state.cart.items);
onRemoveFromCart(updatedCart); // Pass updated cart to parent component (optional)
};
...
return (
showComingSoon ? (
<h1 className="center-checkout-message">Your item will be delivered soon</h1>
) : (
...
<button
className="cart-item-delete" // Adjust class name if needed
